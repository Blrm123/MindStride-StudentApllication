  ...
  >
    ...
    <div className="space-y-3">
      <div className="p-3 rounded-lg bg-slate-50 border-l-4 border-success">
        ...
        <p className="text-sm text-slate-700">&ldquo;Excellent problem-solving skills. Keep up the great work!&rdquo;</p>
      </div>
      ...
      <div className="p-3 rounded-lg bg-slate-50 border-l-4 border-info">
        ...
        <p className="text-sm text-slate-700">&ldquo;Shows strong understanding of concepts. Participates well in class.&rdquo;</p>
      </div>
